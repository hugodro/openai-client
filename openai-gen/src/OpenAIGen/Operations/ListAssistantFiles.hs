...
module OpenAIGen.Operations.ListAssistantFiles where
...
listAssistantFiles :: forall m . OpenAIGen.Common.MonadHTTP m => ListAssistantFilesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> OpenAIGen.Common.ClientT m (Network.HTTP.Client.Types.Response ListAssistantFilesOpResponse) -- ^ Monadic computation which returns the result of the operation
listAssistantFiles parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either ListAssistantFilesOpResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> ListAssistantFilesOpResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                   ListAssistantFilesResponse)
                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAIGen.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/assistants/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (listAssistantFilesParametersPathAssistantId parameters))) GHC.Base.<> "/files")) [OpenAIGen.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> listAssistantFilesParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.False,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 OpenAIGen.Common.QueryParameter (Data.Text.Internal.pack "order") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> listAssistantFilesParametersQueryOrder parameters) (Data.Text.Internal.pack "form") GHC.Types.False,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 OpenAIGen.Common.QueryParameter (Data.Text.Internal.pack "after") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> listAssistantFilesParametersQueryAfter parameters) (Data.Text.Internal.pack "form") GHC.Types.False,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 OpenAIGen.Common.QueryParameter (Data.Text.Internal.pack "before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> listAssistantFilesParametersQueryBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.False])
...
-- 
-- The response constructor is chosen by the status code of the response. If no case matches (no specific case for the response code, no range case, no default case), 'ListAssistantFilesOpResponseError' is used.
data ListAssistantFilesOpResponse =
   ListAssistantFilesOpResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | ListAssistantFilesOpResponse200 ListAssistantFilesResponse -- ^ OK
  deriving (GHC.Show.Show, GHC.Classes.Eq)
