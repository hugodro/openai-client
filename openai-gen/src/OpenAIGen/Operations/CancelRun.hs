...
module OpenAIGen.Operations.CancelRun where
...
cancelRun :: forall m . OpenAIGen.Common.MonadHTTP m => CancelRunParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> OpenAIGen.Common.ClientT m (Network.HTTP.Client.Types.Response CancelRunOpResponse) -- ^ Monadic computation which returns the result of the operation
cancelRun parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either CancelRunOpResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> CancelRunOpResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                        RunObject)
                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAIGen.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") ("/threads/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (cancelRunParametersPathThreadId parameters))) GHC.Base.<> ("/runs/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (cancelRunParametersPathRunId parameters))) GHC.Base.<> "/cancel")))) GHC.Base.mempty)
...
-- 
-- The response constructor is chosen by the status code of the response. If no case matches (no specific case for the response code, no range case, no default case), 'CancelRunOpResponseError' is used.
data CancelRunOpResponse =
   CancelRunOpResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | CancelRunOpResponse200 RunObject -- ^ OK
