...
module OpenAIGen.Operations.GetMessage where
...
-- 
-- Retrieve a message.
getMessage :: forall m . OpenAIGen.Common.MonadHTTP m => GetMessageParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> OpenAIGen.Common.ClientT m (Network.HTTP.Client.Types.Response GetMessageOpResponse) -- ^ Monadic computation which returns the result of the operation
getMessage parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetMessageOpResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetMessageOpResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                           MessageObject)
                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAIGen.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/threads/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (getMessageParametersPathThreadId parameters))) GHC.Base.<> ("/messages/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (getMessageParametersPathMessageId parameters))) GHC.Base.<> "")))) GHC.Base.mempty)
...
-- 
-- The response constructor is chosen by the status code of the response. If no case matches (no specific case for the response code, no range case, no default case), 'GetMessageOpResponseError' is used.
data GetMessageOpResponse =
   GetMessageOpResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetMessageOpResponse200 MessageObject -- ^ OK
