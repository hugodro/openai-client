...
module OpenAIGen.Operations.ModifyMessage where
...
-- 
-- Modifies a message.
modifyMessage :: forall m . OpenAIGen.Common.MonadHTTP m => ModifyMessageParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> ModifyMessageRequest -- ^ The request body to send
  -> OpenAIGen.Common.ClientT m (Network.HTTP.Client.Types.Response ModifyMessageOpResponse) -- ^ Monadic computation which returns the result of the operation
modifyMessage parameters
              body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either ModifyMessageOpResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> ModifyMessageOpResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                              MessageObject)
                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAIGen.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") ("/threads/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (modifyMessageParametersPathThreadId parameters))) GHC.Base.<> ("/messages/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (modifyMessageParametersPathMessageId parameters))) GHC.Base.<> "")))) GHC.Base.mempty (GHC.Maybe.Just body) OpenAIGen.Common.RequestBodyEncodingJSON)
...
-- 
-- The response constructor is chosen by the status code of the response. If no case matches (no specific case for the response code, no range case, no default case), 'ModifyMessageOpResponseError' is used.
data ModifyMessageOpResponse =
   ModifyMessageOpResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | ModifyMessageOpResponse200 MessageObject -- ^ OK
