...
module OpenAIGen.Operations.ListFineTuningEvents where
...
listFineTuningEvents :: forall m . OpenAIGen.Common.MonadHTTP m => ListFineTuningEventsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> OpenAIGen.Common.ClientT m (Network.HTTP.Client.Types.Response ListFineTuningEventsOpResponse) -- ^ Monadic computation which returns the result of the operation
listFineTuningEvents parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either ListFineTuningEventsOpResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> ListFineTuningEventsOpResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                         ListFineTuningJobEventsResponse)
                                                                                                                                                                                   | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAIGen.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/fine_tuning/jobs/" GHC.Base.<> (OpenAIGen.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (OpenAIGen.Common.textToByte GHC.Base.$ OpenAIGen.Common.stringifyModel (listFineTuningEventsParametersPathFineTuningJobId parameters))) GHC.Base.<> "/events")) [OpenAIGen.Common.QueryParameter (Data.Text.Internal.pack "after") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> listFineTuningEventsParametersQueryAfter parameters) (Data.Text.Internal.pack "form") GHC.Types.False,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  OpenAIGen.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> listFineTuningEventsParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.False])
...
-- 
-- The response constructor is chosen by the status code of the response. If no case matches (no specific case for the response code, no range case, no default case), 'ListFineTuningEventsOpResponseError' is used.
data ListFineTuningEventsOpResponse =
   ListFineTuningEventsOpResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | ListFineTuningEventsOpResponse200 ListFineTuningJobEventsResponse -- ^ OK
