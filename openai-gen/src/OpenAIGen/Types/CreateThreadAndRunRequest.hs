...
module OpenAIGen.Types.CreateThreadAndRunRequest where
...
import {-# SOURCE #-} OpenAIGen.Types.CreateThreadRequest
...
data CreateThreadAndRunRequest = CreateThreadAndRunRequest {
  ...
  , createThreadAndRunRequestInstructions :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Text.Internal.Text))
  -- | metadata: Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maxium of 512 characters long.
  , createThreadAndRunRequestMetadata :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object))
  ...
  , createThreadAndRunRequestModel :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Text.Internal.Text))
  -- | thread
  ...
  , createThreadAndRunRequestTools :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable ([CreateThreadAndRunRequestTools'NonNullableVariants])))
