...
module OpenAIGen.Types.CreateCompletionRequest where
...
data CreateCompletionRequest = CreateCompletionRequest {
  ...
  -- * Maxium  of 20.0
  -- * Minimum  of 0.0
  createCompletionRequestBestOf :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  -- | echo: Echo back the prompt in addition to the completion
  , createCompletionRequestEcho :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Bool))
  ...
  -- * Maxium  of 2.0
  -- * Minimum  of -2.0
  , createCompletionRequestFrequencyPenalty :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
  ...
  , createCompletionRequestLogitBias :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object))
  ...
  -- * Maxium  of 5.0
  -- * Minimum  of 0.0
  , createCompletionRequestLogprobs :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  -- 
  -- * Minimum  of 0.0
  , createCompletionRequestMaxTokens :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  -- * Maxium  of 128.0
  -- * Minimum  of 1.0
  , createCompletionRequestN :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  -- * Maxium  of 2.0
  -- * Minimum  of -2.0
  , createCompletionRequestPresencePenalty :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
  -- | prompt: The prompt(s) to generate completions for, encoded as a string, array of strings, array of tokens, or array of token arrays.
  -- 
  -- Note that \<|endoftext|> is the document separator that the model sees during training, so if a prompt is not specified the model will generate as if from the beginning of a new document.
  , createCompletionRequestPrompt :: (OpenAIGen.Common.Nullable CreateCompletionRequestPrompt'NonNullableVariants)
  ...
  , createCompletionRequestSeed :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  -- | stop: Up to 4 sequences where the API will stop generating further tokens. The returned text will not contain the stop sequence.
  , createCompletionRequestStop :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable CreateCompletionRequestStop'NonNullableVariants))
  -- | stream: Whether to stream back partial progress. If set, tokens will be sent as data-only [server-sent events](https:\/\/developer.mozilla.org\/en-US\/docs\/Web\/API\/Server-sent_events\/Using_server-sent_events\#Event_stream_format) as they become available, with the stream terminated by a \`data: [DONE]\` message. [Example Python code](https:\/\/cookbook.openai.com\/examples\/how_to_stream_completions).
  , createCompletionRequestStream :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Bool))
  -- | suffix: The suffix that comes after a completion of inserted text.
  , createCompletionRequestSuffix :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Text.Internal.Text))
  ...
  -- * Maxium  of 2.0
  -- * Minimum  of 0.0
  , createCompletionRequestTemperature :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
  ...
  -- * Maxium  of 1.0
  -- * Minimum  of 0.0
  , createCompletionRequestTopP :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
...
mkCreateCompletionRequest :: CreateCompletionRequestModel'Variants -- ^ 'createCompletionRequestModel'
  -> OpenAIGen.Common.Nullable CreateCompletionRequestPrompt'NonNullableVariants -- ^ 'createCompletionRequestPrompt'
...
data CreateCompletionRequestStop'NonNullableVariants =
   CreateCompletionRequestStop'NonNullableNullableText (OpenAIGen.Common.Nullable Data.Text.Internal.Text)
