...
module OpenAIGen.Types.CreateChatCompletionResponse where
...
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionResponseMessage
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionTokenLogprob
import {-# SOURCE #-} OpenAIGen.Types.CompletionUsage
...
data CreateChatCompletionResponseChoices' = CreateChatCompletionResponseChoices' {
  ...
  , createChatCompletionResponseChoices'Logprobs :: (OpenAIGen.Common.Nullable CreateChatCompletionResponseChoices'Logprobs'NonNullable)
...
mkCreateChatCompletionResponseChoices' :: CreateChatCompletionResponseChoices'FinishReason' -- ^ 'createChatCompletionResponseChoices'FinishReason'
  ...
  -> OpenAIGen.Common.Nullable CreateChatCompletionResponseChoices'Logprobs'NonNullable -- ^ 'createChatCompletionResponseChoices'Logprobs'
...
data CreateChatCompletionResponseChoices'Logprobs'NonNullable = CreateChatCompletionResponseChoices'Logprobs'NonNullable {
  ...
  createChatCompletionResponseChoices'Logprobs'NonNullableContent :: (OpenAIGen.Common.Nullable ([ChatCompletionTokenLogprob]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
...
mkCreateChatCompletionResponseChoices'Logprobs'NonNullable :: OpenAIGen.Common.Nullable ([ChatCompletionTokenLogprob]) -- ^ 'createChatCompletionResponseChoices'Logprobs'NonNullableContent'
