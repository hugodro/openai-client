...
module OpenAIGen.Types.CreateImageRequest where
...
data CreateImageRequest = CreateImageRequest {
  ...
  createImageRequestModel :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable CreateImageRequestModel'NonNullableVariants))
  ...
  -- * Maxium  of 10.0
  -- * Minimum  of 1.0
  , createImageRequestN :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  , createImageRequestResponseFormat :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable CreateImageRequestResponseFormat'NonNullable))
  ...
  , createImageRequestSize :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable CreateImageRequestSize'NonNullable))
  ...
  , createImageRequestStyle :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable CreateImageRequestStyle'NonNullable))
