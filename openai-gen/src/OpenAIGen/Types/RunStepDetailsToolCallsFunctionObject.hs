...
module OpenAIGen.Types.RunStepDetailsToolCallsFunctionObject where
...
data RunStepDetailsToolCallsFunctionObjectFunction' = RunStepDetailsToolCallsFunctionObjectFunction' {
  ...
  , runStepDetailsToolCallsFunctionObjectFunction'Output :: (OpenAIGen.Common.Nullable Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
...
mkRunStepDetailsToolCallsFunctionObjectFunction' :: Data.Text.Internal.Text -- ^ 'runStepDetailsToolCallsFunctionObjectFunction'Arguments'
  ...
  -> OpenAIGen.Common.Nullable Data.Text.Internal.Text -- ^ 'runStepDetailsToolCallsFunctionObjectFunction'Output'
