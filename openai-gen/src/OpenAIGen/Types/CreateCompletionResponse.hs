...
module OpenAIGen.Types.CreateCompletionResponse where
...
data CreateCompletionResponseChoices' = CreateCompletionResponseChoices' {
  ...
  -- | logprobs
  , createCompletionResponseChoices'Logprobs :: (OpenAIGen.Common.Nullable CreateCompletionResponseChoices'Logprobs'NonNullable)
  -- | text
...
mkCreateCompletionResponseChoices' :: CreateCompletionResponseChoices'FinishReason' -- ^ 'createCompletionResponseChoices'FinishReason'
  ...
  -> OpenAIGen.Common.Nullable CreateCompletionResponseChoices'Logprobs'NonNullable -- ^ 'createCompletionResponseChoices'Logprobs'
