...
module OpenAIGen.Types.RunStepObject where
...
import {-# SOURCE #-} OpenAIGen.Types.RunStepCompletionUsage
import {-# SOURCE #-} OpenAIGen.Types.RunStepDetailsMessageCreationObject
import {-# SOURCE #-} OpenAIGen.Types.RunStepDetailsToolCallsObject
...
data RunStepObject = RunStepObject {
  ...
  , runStepObjectCancelledAt :: (OpenAIGen.Common.Nullable GHC.Types.Int)
  -- | completed_at: The Unix timestamp (in seconds) for when the run step completed.
  , runStepObjectCompletedAt :: (OpenAIGen.Common.Nullable GHC.Types.Int)
  ...
  , runStepObjectExpiredAt :: (OpenAIGen.Common.Nullable GHC.Types.Int)
  -- | failed_at: The Unix timestamp (in seconds) for when the run step failed.
  , runStepObjectFailedAt :: (OpenAIGen.Common.Nullable GHC.Types.Int)
  ...
  , runStepObjectLastError :: (OpenAIGen.Common.Nullable RunStepObjectLastError'NonNullable)
  -- | metadata: Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maxium of 512 characters long.
  , runStepObjectMetadata :: (OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object)
...
mkRunStepObject :: Data.Text.Internal.Text -- ^ 'runStepObjectAssistantId'
  -> OpenAIGen.Common.Nullable GHC.Types.Int -- ^ 'runStepObjectCancelledAt'
  -> OpenAIGen.Common.Nullable GHC.Types.Int -- ^ 'runStepObjectCompletedAt'
  -> GHC.Types.Int -- ^ 'runStepObjectCreatedAt'
  -> OpenAIGen.Common.Nullable GHC.Types.Int -- ^ 'runStepObjectExpiredAt'
  -> OpenAIGen.Common.Nullable GHC.Types.Int -- ^ 'runStepObjectFailedAt'
  -> Data.Text.Internal.Text -- ^ 'runStepObjectId'
  -> OpenAIGen.Common.Nullable RunStepObjectLastError'NonNullable -- ^ 'runStepObjectLastError'
  -> OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object -- ^ 'runStepObjectMetadata'
