...
module OpenAIGen.Types.CreateChatCompletionRequest where
...
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionFunctionCallOption
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionFunctions
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionRequestMessage
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionTool
import {-# SOURCE #-} OpenAIGen.Types.ChatCompletionToolChoiceOption
...
data CreateChatCompletionRequest = CreateChatCompletionRequest {
  ...
  -- * Maxium  of 2.0
  -- * Minimum  of -2.0
  createChatCompletionRequestFrequencyPenalty :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
  ...
  , createChatCompletionRequestLogitBias :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object))
  ...
  , createChatCompletionRequestLogprobs :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Bool))
  ...
  , createChatCompletionRequestMaxTokens :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  -- * Maxium  of 128.0
  -- * Minimum  of 1.0
  , createChatCompletionRequestN :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  -- * Maxium  of 2.0
  -- * Minimum  of -2.0
  , createChatCompletionRequestPresencePenalty :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
  ...
  , createChatCompletionRequestSeed :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  , createChatCompletionRequestStream :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Bool))
  ...
  -- * Maxium  of 2.0
  -- * Minimum  of 0.0
  , createChatCompletionRequestTemperature :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
  ...
  -- * Maxium  of 5.0
  -- * Minimum  of 0.0
  , createChatCompletionRequestTopLogprobs :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Int))
  ...
  -- * Maxium  of 1.0
  -- * Minimum  of 0.0
  , createChatCompletionRequestTopP :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable GHC.Types.Double))
...
data CreateChatCompletionRequestStop'Variants =
   CreateChatCompletionRequestStop'NullableText (OpenAIGen.Common.Nullable Data.Text.Internal.Text)
