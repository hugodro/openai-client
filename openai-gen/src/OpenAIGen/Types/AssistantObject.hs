...
data AssistantObject = AssistantObject {
  ...
  , assistantObjectDescription :: (OpenAIGen.Common.Nullable Data.Text.Internal.Text)
  ...
  , assistantObjectInstructions :: (OpenAIGen.Common.Nullable Data.Text.Internal.Text)
  -- | metadata: Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maxium of 512 characters long.
  , assistantObjectMetadata :: (OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object)
  ...
  , assistantObjectName :: (OpenAIGen.Common.Nullable Data.Text.Internal.Text)
...
mkAssistantObject :: GHC.Types.Int -- ^ 'assistantObjectCreatedAt'
  -> OpenAIGen.Common.Nullable Data.Text.Internal.Text -- ^ 'assistantObjectDescription'
  -> [Data.Text.Internal.Text] -- ^ 'assistantObjectFileIds'
  -> Data.Text.Internal.Text -- ^ 'assistantObjectId'
  -> OpenAIGen.Common.Nullable Data.Text.Internal.Text -- ^ 'assistantObjectInstructions'
  -> OpenAIGen.Common.Nullable Data.Aeson.Types.Internal.Object -- ^ 'assistantObjectMetadata'
  -> Data.Text.Internal.Text -- ^ 'assistantObjectModel'
  -> OpenAIGen.Common.Nullable Data.Text.Internal.Text -- ^ 'assistantObjectName'
