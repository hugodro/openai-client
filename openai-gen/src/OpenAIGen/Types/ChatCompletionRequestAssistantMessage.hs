...
module OpenAIGen.Types.ChatCompletionRequestAssistantMessage where
...
data ChatCompletionRequestAssistantMessage = ChatCompletionRequestAssistantMessage {
  ...
  chatCompletionRequestAssistantMessageContent :: (GHC.Maybe.Maybe (OpenAIGen.Common.Nullable Data.Text.Internal.Text))
