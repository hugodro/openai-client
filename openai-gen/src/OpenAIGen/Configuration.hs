...
module OpenAIGen.Configuration where
...
defaultConfiguration = OpenAIGen.Common.Configuration defaultURL OpenAIGen.Common.anonymousSecurityScheme GHC.Types.True defaultApplicationName
